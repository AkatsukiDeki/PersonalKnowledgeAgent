...
export function MemoryOrbit({ isOpen, onClose, context }: Props) {
  ...
  return (
    <aside className="w-80 bg-[#0a0a0a]/70 backdrop-blur-xl border-l border-white/5 flex flex-col shrink-0 overflow-hidden text-slate-200">
      {/* Header */}
      <div className="h-14 flex items-center justify-between px-4 border-b border-white/5 bg-white/[0.02]">
