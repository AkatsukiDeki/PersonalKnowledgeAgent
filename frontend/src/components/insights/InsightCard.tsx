...
export function InsightCard({ insight, onInspect }: Props) {
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5 flex flex-col justify-between gap-4 shadow-lg hover:border-zinc-700 transition-colors min-h-[300px]">
      <div className="flex justify-between items-start">
        <div className="flex gap-3 items-center">
          ...
          <h3 className="text-zinc-100 font-semibold text-sm leading-tight line-clamp-2 min-h-[2.5rem]">
            {insight.title}
          </h3>
        </div>
      </div>
